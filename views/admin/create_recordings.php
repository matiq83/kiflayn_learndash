...
<div class="wrap">
<h2><?php echo __( 'Create Recordings', KIFLAYN_LEARNDASH_TEXT_DOMAIN );?></h2>
<table class="wp-list-table widefat fixed" cellspacing="0">
	<thead>
        <tr>
            <th scope="col" class="manage-column" style=""><?php echo __( 'Create Recordings', KIFLAYN_LEARNDASH_TEXT_DOMAIN );?></th>
        </tr>
	</thead>
	<tbody id="the-list">
        <tr>
            <td align="center">
                ...
                <table width="100%" class="form-table">
                    ...
                    <tr valign="top" class="kiflayn_learndash_hidden">
                        <td>
                            <?php echo __( 'Meetings', KIFLAYN_LEARNDASH_TEXT_DOMAIN );?>
                        </td>
                        <td id="zoom_meetings_container">
